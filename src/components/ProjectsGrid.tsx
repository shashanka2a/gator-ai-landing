...
const projects = [
  {
    ...
    description: "Autonomous coding agent that writes, tests, & deploys production-ready code using advanced reasoning-grade chains & intelligent automation.",
  ...
  },
  {
    ...
    description: "Campus-trained LLM specialized in software engineering, built on HiPerGator infrastructure with advanced reasoning-grade capabilities.",
  ...
  },
  {
    ...
    description: "Real-time market analysis & trading strategies powered by multi-agent AI systems with intelligent decision-making capabilities.",
